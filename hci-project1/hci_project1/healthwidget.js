...
function setupHealthWidget(px, py) {
  health = createButton('').class("graphWidButton").html('<i class="fa fa-heartbeat" style="color:red;"> Exercise</i>', true);
  weight = createButton('').class("graphWidButton").html('<i class="fa fa-weight" style="color:green"> Weight</i>', true);
  sleep = createButton('').class("graphWidButton").html('<i class="fa fa-moon" style="color:skyblue"> Sleep</i>', true);
  steps = createButton('').class("graphWidButton").html('<i class="fa fa-walking" style="color:orange"> Steps</i>', true);
  standing = createButton('').class("graphWidButton").html('<i class="fa fa-male" style="color:blue"> Standing</i>', true);
  mirror = createButton('').class("graphWidButton").html('<i class="fa fa-user" style="color:purple"> Usage</i>', true);
